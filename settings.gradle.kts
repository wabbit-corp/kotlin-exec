...
// managed-integrity-v1: WYeqDmhWwbD
//
...
val applyLocalSettingsOverlay =
    providers.gradleProperty("wabbit.applyLocalSettingsOverlay")
        .orElse(providers.environmentVariable("WABBIT_APPLY_LOCAL_SETTINGS_OVERLAY"))
        .map { it.parseWabbitBooleanFlag("wabbit.applyLocalSettingsOverlay") }
        .orElse(true)
        .get()
...
if (applyLocalSettingsOverlay && localSettingsFile.isFile) {
