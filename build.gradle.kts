...
// managed-integrity-v1: VLKTwaaZw6q
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-exec", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-exec")
        description.set("Kotlin JVM process execution primitives with bounded capture, structured errors, and explicit process lifecycle policies.")
        url.set("https://github.com/wabbit-corp/kotlin-exec")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-exec")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-exec.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-exec.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-exec"
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-exec/tree/master/src")
